  ...
  return (
    ...
    >
      ...
      <ul className="hidden md:flex ml-auto items-center gap-14 text-xs font-semibold tracking-widest uppercase">
        ...
        <Link to="/contact">
          <li
            className={`cursor-pointer pb-0.5 transition duration-300 border-b-2 ${location.pathname === "/contact" ? "text-accent-teal border-accent-teal" : "text-gray-300 hover:text-white border-transparent hover:border-white/40"}`}
          >
            CONTACT US
          </li>
        </Link>
      ...
      >
        ...
        <Link
          to="/contact"
          onClick={() => setIsMobileMenuOpen(false)}
          className={`text-sm font-semibold tracking-widest uppercase transition duration-300 ${location.pathname === "/contact" ? "text-accent-teal" : "text-gray-300 hover:text-white"}`}
        >
          CONTACT US
        </Link>
        {user ? (
